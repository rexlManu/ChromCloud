package me.rexlmanu.chromcloudcore.utility.packet;
...
/**
 * Created by Emmanuel L. on 18.09.2018
 */

@Getter
public class Buffer extends ByteBuf implements Cloneable {
    ...
    @Override
    public Buffer clone() {
        return new Buffer(Unpooled.buffer(byteBuf.readableBytes()).writeBytes(byteBuf));
    }
